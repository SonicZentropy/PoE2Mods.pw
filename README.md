...
Using the program is straight-forward:
	...
	Copy "ModIniFile.ini" to your base POE2 directory next to the exe.  Copy "INIFileParser.dll" to the Pillars of Eternity II\PillarsOfEternityII_Data\Managed subdir next to Assembly-CSharp.dll
